...
Agent: weather-alice
═════════════════════
20-turn weather conversation with weather-bob via Pluto server.
Alice asks on odd turns (1,3,5,...,19) and answers on even turns (2,4,6,...,20).
